...
CREATE TABLE IF NOT EXISTS ttk_profile (
  ...
  weapon_parameter INTEGER,
  wp_max_bonus_pct REAL,
  wp_bonus_pct REAL,
  damage_crit REAL,
  damage_body REAL,
  effective_damage_crit REAL,
  effective_damage_body REAL,
  body_forgiveness_count INTEGER,
  body_forgiveness_pct REAL,
